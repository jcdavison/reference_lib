...
#### Write TRUE code ( transparent, reasonable, usable, exemplary )
  ...
  * Reasonable, the cost of any change shold be proportional to the beenfits of the change it achieves.
...
#### Methods with single responsibilities 
  ...
  * Encourage reuse.
  * Are east to move to another class.
...
#### DUCK TYPING, public interfaces that are not tied to any specific class.
